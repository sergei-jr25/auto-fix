(() => {
  ...
  let e = (e, t = 500, s = 0) => {
    ...
    s = (s, i = 500) => (s.hidden ? t(s, i) : e(s, i)),
    i = !0,
    a = (e = 500) => {
  ...
  const o = document.querySelectorAll("[data-scroll]");
  function c() {
    o.forEach((e, t) => {
  ...
  const h = document.querySelectorAll("select"),
    m = {
      selectClasses: {
        classSelect: "select",
      ...
      getSelectElement: (e, t) => ({
        ...
        selectElement: e.querySelector(m.getSelectClass(t)),
      }),
      selectsInit(e) {
        e.forEach((e, t) => {
          (e.dataset.id = t), m.selectInit(e);
        }),
          document.addEventListener("click", m.selectsActions),
          document.addEventListener("keydown", m.selectsActions),
          document.addEventListener("focusin", m.selectsActions),
          document.addEventListener("focusout", m.selectsActions);
      },
      selectInit(e) {
        let t = document.createElement("div");
        if (
          (t.classList.add(m.selectClasses.classSelect),
          e.parentNode.insertBefore(t, e),
          t.appendChild(e),
          (e.hidden = !0),
          t.insertAdjacentHTML(
            "beforeend",
            `<div class="${m.selectClasses.classSelectBody}"><div hidden class="${m.selectClasses.classSelectOptions}"></div></div>`
          ),
          m.selectBuild(e),
          m.getSelectPlaceholder(e) &&
            ((e.dataset.placeholder = m.getSelectPlaceholder(e).value),
            m.getSelectPlaceholder(e).label.show))
        ) {
          m.getSelectElement(
            t,
            m.selectClasses.classSelectTitle
          ).selectElement.insertAdjacentHTML(
            "afterbegin",
            `<span class="${m.selectClasses.classSelectLabel}">${
              m.getSelectPlaceholder(e).label.text
                ? m.getSelectPlaceholder(e).label.text
                : m.getSelectPlaceholder(e).value
            }</span>`
          );
        }
        (e.dataset.speed = e.dataset.speed ? e.dataset.speed : "150"),
          e.addEventListener("change", m.selectChange);
      },
      selectBuild(e) {
        ...
        (t.dataset.id = e.dataset.id),
          ...
          e.multiple
            ? t.classList.add(m.selectClasses.classSelectMultiple)
            : t.classList.remove(m.selectClasses.classSelectMultiple),
          e.hasAttribute("data-checkbox") && e.multiple
            ? t.classList.add(m.selectClasses.classSelectCheckBox)
            : t.classList.remove(m.selectClasses.classSelectCheckBox),
          m.setSelectTitleValue(t, e),
          m.setOptions(t, e),
          e.hasAttribute("data-search") && m.searchActions(t),
          e.hasAttribute("data-open") && m.selectAction(t),
          m.selectDisabled(t, e);
      },
      selectsActions(e) {
        const t = e.target,
          s = e.type;
        if (
          t.closest(m.getSelectClass(m.selectClasses.classSelect)) ||
          t.closest(m.getSelectClass(m.selectClasses.classSelectTag))
        ) {
          const i = t.closest(".select")
              ? t.closest(".select")
              : document.querySelector(
                  `.${m.selectClasses.classSelect}[data-id="${
                    t.closest(m.getSelectClass(m.selectClasses.classSelectTag))
                      .dataset.selectId
                  }"]`
                ),
            a = m.getSelectElement(i).originalSelect;
          if ("click" === s) {
            if (!a.disabled)
              if (t.closest(m.getSelectClass(m.selectClasses.classSelectTag))) {
                const e = t.closest(
                    m.getSelectClass(m.selectClasses.classSelectTag)
                  ),
                  s = document.querySelector(
                    `.${m.selectClasses.classSelect}[data-id="${e.dataset.selectId}"] .select__option[data-value="${e.dataset.value}"]`
                  );
                m.optionAction(i, a, s);
              } else if (
                t.closest(m.getSelectClass(m.selectClasses.classSelectTitle))
              )
                m.selectAction(i);
              else if (
                t.closest(m.getSelectClass(m.selectClasses.classSelectOption))
              ) {
                const e = t.closest(
                  m.getSelectClass(m.selectClasses.classSelectOption)
                );
                m.optionAction(i, a, e);
              }
          } else
            "focusin" === s || "focusout" === s
              ? t.closest(m.getSelectClass(m.selectClasses.classSelect)) &&
                ("focusin" === s
                  ? i.classList.add(m.selectClasses.classSelectFocus)
                  : i.classList.remove(m.selectClasses.classSelectFocus))
              : "keydown" === s && "Escape" === e.code && m.selectsСlose();
        } else m.selectsСlose();
      },
      selectsСlose() {
        const e = document.querySelectorAll(
          `${m.getSelectClass(m.selectClasses.classSelect)}${m.getSelectClass(
            m.selectClasses.classSelectOpen
          )}`
        );
        e.length &&
          e.forEach((e) => {
      ...
      selectAction(e) {
        const t = m.getSelectElement(e).originalSelect,
          i = m.getSelectElement(
            e,
            m.selectClasses.classSelectOptions
          ).selectElement;
        i.classList.contains("_slide") ||
          (e.classList.toggle(m.selectClasses.classSelectOpen),
          s(i, t.dataset.speed));
      },
      setSelectTitleValue(e, t) {
        const s = m.getSelectElement(
            e,
            m.selectClasses.classSelectBody
          ).selectElement,
          i = m.getSelectElement(
            e,
            m.selectClasses.classSelectTitle
        ...
        i && i.remove(),
          s.insertAdjacentHTML("afterbegin", m.getSelectTitleValue(e, t));
      },
      getSelectTitleValue(e, t) {
        let s = m.getSelectedOptionsData(t, 2).html;
        if (
          (t.multiple &&
              ...
              .elements.map(
                (t) =>
                  `<span role="button" data-select-id="${
                    ...
                    t.value
                  }" class="_select-tag">${m.getSelectElementContent(t)}</span>`
              )
              .join("")),
            t.dataset.tags &&
          ...
          m.getSelectedOptionsData(t).values.length
            ? e.classList.add(m.selectClasses.classSelectActive)
            : e.classList.remove(m.selectClasses.classSelectActive),
          t.hasAttribute("data-search"))
        )
          return `<div class="${m.selectClasses.classSelectTitle}"><span class="${m.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${s}" data-placeholder="${s}" class="${m.selectClasses.classSelectInput}"></span></div>`;
        {
          const e =
            m.getSelectedOptionsData(t).elements.length &&
            m.getSelectedOptionsData(t).elements[0].dataset.class
              ? ` ${m.getSelectedOptionsData(t).elements[0].dataset.class}`
              : "";
          return `<button type="button" class="${m.selectClasses.classSelectTitle}"><span class="${m.selectClasses.classSelectValue}"><span class="${m.selectClasses.classSelectContent}${e}">${s}</span></span></button>`;
        }
      },
      getSelectElementContent(e) {
        ...
        let i = "";
        return (
          (i += t ? `<span class="${m.selectClasses.classSelectRow}">` : ""),
          (i += t ? `<span class="${m.selectClasses.classSelectData}">` : ""),
          (i += t ? s : ""),
          (i += t ? "</span>" : ""),
          (i += t ? `<span class="${m.selectClasses.classSelectText}">` : ""),
          (i += e.textContent),
          (i += t ? "</span>" : ""),
          (i += t ? "</span>" : ""),
          i
      ...
      getSelectedOptionsData(e, t) {
        ...
        return (
            ...
            : s.push(e.options[e.selectedIndex]),
          {
            ...
            html: s.map((e) => m.getSelectElementContent(e)),
          }
        );
      },
      getOptions(e) {
        ...
        if (i.length > 0) {
          let a = "";
          return (
            ((m.getSelectPlaceholder(e) && !m.getSelectPlaceholder(e).show) ||
              e.multiple) &&
              (i = i.filter((e) => e.value)),
            (a += t
              ? `<div ${t} ${s} class="${m.selectClasses.classSelectOptionsScroll}">`
              : ""),
            i.forEach((t) => {
              a += m.getOption(t, e);
            }),
      ...
      getOption(e, t) {
        const s =
            e.selected && t.multiple
              ? ` ${m.selectClasses.classSelectOptionSelected}`
              : "",
          i =
        ...
        let n = "";
        return (
          (n += `<button ${i} class="${m.selectClasses.classSelectOption}${a}${s}" data-value="${e.value}" type="button">`),
          (n += m.getSelectElementContent(e)),
          (n += "</button>"),
          n
        );
      },
      setOptions(e, t) {
        m.getSelectElement(
          e,
          m.selectClasses.classSelectOptions
        ).selectElement.innerHTML = m.getOptions(t);
      },
      optionAction(e, t, s) {
        if (t.multiple) {
          s.classList.toggle(m.selectClasses.classSelectOptionSelected);
          m.getSelectedOptionsData(t).elements.forEach((e) => {
            e.removeAttribute("selected");
          });
          e.querySelectorAll(
            m.getSelectClass(m.selectClasses.classSelectOptionSelected)
          ).forEach((e) => {
          ...
          t.hasAttribute("data-show-selected") ||
            (e.querySelector(
              `${m.getSelectClass(m.selectClasses.classSelectOption)}[hidden]`
            ) &&
              (e.querySelector(
                `${m.getSelectClass(m.selectClasses.classSelectOption)}[hidden]`
              ).hidden = !1),
            ...
            (t.value = s.hasAttribute("data-value")
              ...
              : s.textContent),
            m.selectAction(e);
        m.setSelectTitleValue(e, t), m.setSelectChange(t);
      },
      selectChange(e) {
        m.selectBuild(e.target), m.setSelectChange(e.target);
      },
      setSelectChange(e) {
        const t = e.parentElement;
        m.selectCallback(t, e);
      },
      selectDisabled(e, t) {
        t.disabled
          ? (e.classList.add(m.selectClasses.classSelectDisabled),
            (m.getSelectElement(
              e,
              m.selectClasses.classSelectTitle
            ).selectElement.disabled = !0))
          : (e.classList.remove(m.selectClasses.classSelectDisabled),
            (m.getSelectElement(
              e,
              m.selectClasses.classSelectTitle
      ...
      searchActions(e) {
        m.getSelectElement(e).originalSelect;
        const t = m.getSelectElement(
            e,
            m.selectClasses.classSelectInput
          ).selectElement,
          s = m.getSelectElement(
            e,
            m.selectClasses.classSelectOptions
          ).selectElement,
          i = s.querySelectorAll(`.${m.selectClasses.classSelectOption}`);
  ...
  h.length
    ? m.selectsInit(h)
    : m.setLogging("Нет ни одного select, модуль можно отключить"),
    document.addEventListener("DOMContentLoaded", function () {
      var e = function (e) {
          var t = e.target,
            ...
            n = 0,
            l = a.replace(/\D/g, ""),
            r = e.target.value.replace(/\D/g, "");
          "false" !== s &&
          "blur" === e.type &&
          r.length < a.match(/([\_\d])/g).length
            ? (e.target.value = "")
            : (l.length >= r.length && (r = l),
              (e.target.value = a.replace(/./g, function (e) {
                return /[_\d]/.test(e) && n < r.length
                  ? r.charAt(n++)
                  : n >= r.length
                  ? ""
                  : e;
  ...
  const k = {
    ...
    on: function (...e) {
      ...
      function n(e) {
        ...
        if ((a.indexOf(e) < 0 && a.unshift(e), T(t).is(s))) i.apply(t, a);
        else {
          const e = T(t).parents();
          for (let t = 0; t < e.length; t += 1)
            T(e[t]).is(s) && i.apply(e[t], a);
        }
      }
      function l(e) {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (a = T(e), n = 0; n < a.length; n += 1) if (a[n] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
  ...
  Object.keys(k).forEach((e) => {
    Object.defineProperty(T.fn, e, { value: k[e], writable: !0 });
  });
  const A = T;
  function $(e, t) {
          ...
          void 0 !== n &&
            ...
            (_(e[a]) && _(i[a])
              ? i[a].__swiper__
                ...
                : I(e[a], i[a])
              : !_(e[a]) && _(i[a])
              ? ((e[a] = {}), i[a].__swiper__ ? (e[a] = i[a]) : I(e[a], i[a]))
              : (e[a] = i[a]));
        }
      }
    }
      ...
      if (
        ...
        if (0 === t) r[e ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!n.support.smoothScroll)
            return (
              D({ swiper: n, targetPosition: -d, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, a) {
      ...
      if (r.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              D({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  const Y = {
    loopCreate: function () {
      const e = this,
        ...
        a = i.children().length > 0 ? A(i.children()[0].parentNode) : i;
      ...
      for (let e = 0; e < r.length; e += 1)
        a.append(A(r[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = l.length - 1; e >= 0; e -= 1)
        a.prepend(A(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function Q(e) {
    ...
    if (!s.allowTouchMove)
      return (
        A(o.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
    ...
    if (
      ...
      A(o.target).is(i.focusableElements)
    )
  ...
  const le = {
    setBreakpoint: function () {
      ...
      u && s && e.changeDirection(), I(e.params, o);
  ...
  class ue {
    constructor() {
      ...
      (n.__swiper__ = !0),
        (n.support = N()),
        (n.device = H({ userAgent: t.userAgent })),
        (n.browser = j()),
        (n.eventsListeners = {}),
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: n } = t.navigation,
          l = s.target;
        if (t.params.navigation.hideOnClick && !A(l).is(n) && !A(l).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function ve(e) {
    ...
    function d() {
      ...
      if (
        ("fraction" === s.type &&
          (n.find(ge(s.currentClass)).text(s.formatFractionCurrent(d + 1)),
          n.find(ge(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(n), (t.pagination.bullets = i.find(ge(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((n = e.renderFraction
    ...
    i("init", () => {
      ...
      i("click", (e, s) => {
        ...
        if (
          ...
          n.length > 0 &&
          !A(i).hasClass(t.params.pagination.bulletClass)
        ) {
          if (
            t.navigation &&
      ...
      ymaps.ready(function () {
        ...
        a.events.add("click", function () {
          ymaps.geolocation.get().then(function (e) {
            ...
            ymaps.route([s, a.geometry.getCoordinates()]).then(function (e) {
  ...
  setTimeout(() => {
    ...
    (we.prototype.moveTo = function (e, t, s) {
    ...
    (we.prototype.moveBack = function (e, t, s) {
    ...
    (function () {
      ...
      function n(s) {
        let i = s.querySelectorAll("[data-tabs-title]"),
          a = s.querySelectorAll("[data-tabs-item]");
        const n = s.dataset.tabsIndex;
        const l = (function (e) {
        ...
        if (a.length > 0) {
          const r = s.hasAttribute("data-tabs-hash");
          (a = Array.from(a).filter((e) => e.closest("[data-tabs]") === s)),
